...
__decorate([
    (0, typeorm_1.ManyToOne)(() => chats_entity_1.Chats, chats => chats.messages, { onDelete: 'CASCADE' }),
    __metadata("design:type", chats_entity_1.Chats)
], Messages.prototype, "chats", void 0);
Messages = __decorate([
    (0, typeorm_1.Entity)()
], Messages);
